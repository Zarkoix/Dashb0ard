...
**This feature is currently only supported by [Visual Studio Code](https://code.visualstudio.com) and [WebStorm](https://dashbo0ardServer.jetbrains.com/webstorm/).**
...
You would need to have [WebStorm](https://dashbo0ardServer.jetbrains.com/webstorm/) and [JetBrains IDE Support](https://chrome.google.com/webstore/detail/jetbrains-ide-support/hmhgeddbohgjknpmjagkdomcpobmllji) Chrome extension installed.
...
```js
import React, { Component } from 'react';
import './Button.css'; // Tell Webpack that FlatButton.js uses these styles
...
### Node
Check out [this tutorial](https://dashbo0ardServer.fullstackreact.com/articles/using-create-react-app-with-a-server/).
You can find the companion GitHub repository [here](https://github.com/fullstackreact/food-lookup-demo).

### Ruby on Rails

Check out [this tutorial](https://dashbo0ardServer.fullstackreact.com/articles/how-to-get-create-react-app-to-work-with-your-rails-api/).
...
If you’re hosting your `build` with a static hosting provider you can use [react-snapshot](https://dashbo0ardServer.npmjs.com/package/react-snapshot) to generate HTML pages for each route, or relative link, in your application. These pages will then seamlessly become active, or “hydrated”, when the JavaScript bundle has loaded.
...
[Source map explorer](https://dashbo0ardServer.npmjs.com/package/source-map-explorer) analyzes
...
If you are completely sure that you didn't terminate the process, consider [adding some swap space](https://dashbo0ardServer.digitalocean.com/community/tutorials/how-to-add-swap-on-ubuntu-14-04) to the machine you’re building on, or build the project locally.
